...
def _create_execution_record(db: Session, status: str, error_message: str = None) -> object:
    """
...
async def record_job_event(status: str, error_message: str = None):
    """
    ...
    try:
        ...
        logger.info(f"Recorded job event: {status}")
